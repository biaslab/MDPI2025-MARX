...
plot_system_params_A(results["MARX-WI"].envs_train[1], results["MARX-WI"].agents[1], psize=(4*dpi,0.6dpi), f_name="figures/MARX-coeffs-A-system.png")
...
plot_pdf_predictive(pdf_param_data, f_name="figures/MARX-pdf-predictive.png")
...
plot_param_W_timeseries(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T], sys=results["MARX-WI"].envs_train[hyperparams_run_WI.run,hyperparams_debug.T], psize=(5*dpi, 2*dpi), f_name="figures/MARX-coeffs-W-timeseries")

# ╔═╡ 425cb22a-def8-4aa5-bb27-96b2ad0b9e09
A_indices = [(1,1), (2,1), (1,6), (2,6)]

# ╔═╡ f67cf7f4-a1d1-4e55-85b5-a11d966fabe9
plot_params_A_diff(results["MARX-WI"].envs_train[hyperparams_run_WI.run], results["MARX-WI"].agents[hyperparams_run_WI.run], psize=(4*dpi,0.6dpi), indices=A_indices, f_name="figures/MARX-coeffs-A-diff.png")

# ╔═╡ 2aa3144e-936b-4ab9-bbca-088e65e1cb76
plot_param_M_timeseries(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T], sys=results["MARX-WI"].envs_train[hyperparams_run_WI.run,hyperparams_debug.T], indices=A_indices, f_name="figures/MARX-coeffs-A-timeline-selection.png")

# ╔═╡ 744b7c90-ae12-4081-9475-d840879aedad
plot_ces_posterior_likelihood_kls_posterior_prior(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T]; show_surprisals=true, f_name="figures/MARX-ces_posterior_likelihood_kls_posterior_prior.png")

# ╔═╡ 67af74c2-b8ae-4d0e-81a9-b835ab99cc0a
plot_es_posterior(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T], f_name="figures/MARX-es_posterior.png")
...
[[MARX]]
deps = ["Aqua", "CSV", "ColorSchemes", "CpuId", "DSP", "DataFrames", "Distributed", "Distributions", "FFMPEG", "FFTW", "IterTools", "JLD2", "LaTeXStrings", "LinearAlgebra", "Logging", "MAT", "MATLAB", "Markdown", "Plots", "Pluto", "PlutoUI", "Printf", "ReTestItems", "Revise", "SpecialFunctions", "Statistics", "StatsPlots", "Test"]
