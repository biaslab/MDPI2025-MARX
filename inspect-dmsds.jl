...
# ╔═╡ e4472ca8-10cc-4a2f-90ec-b15077e378f4
md"# NOTE: This is still under construction"
...
plot_pdf_params(pdf_param_data)

# ╔═╡ 2792d246-0377-40f7-adf5-ef99d023aa9f
plot_param_A_norm(param_norm_A_data, logscale=true)

# ╔═╡ 87614be1-7870-444d-b985-8dda3844aa2f
plot_param_W_norm(param_norm_W_data, logscale=true)

# ╔═╡ 408cb4a4-3e56-45e9-9b08-cf43116ceb18
plot_pdf_predictive(pdf_param_data)
...
plot_param_W_timeseries(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T], sys=results["MARX-WI"].envs_train[hyperparams_run_WI.run,hyperparams_debug.T], psize=(5*dpi, 2*dpi))

# ╔═╡ 425cb22a-def8-4aa5-bb27-96b2ad0b9e09
A_indices = [(1,1), (2,1), (1,6), (2,6)]

# ╔═╡ f67cf7f4-a1d1-4e55-85b5-a11d966fabe9
plot_params_A_diff(results["MARX-WI"].envs_train[hyperparams_run_WI.run], results["MARX-WI"].agents[hyperparams_run_WI.run], psize=(4*dpi,0.6dpi), indices=A_indices)

# ╔═╡ 2aa3144e-936b-4ab9-bbca-088e65e1cb76
plot_param_M_timeseries(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T], sys=results["MARX-WI"].envs_train[hyperparams_run_WI.run,hyperparams_debug.T], indices=A_indices)

# ╔═╡ 744b7c90-ae12-4081-9475-d840879aedad
plot_ces_posterior_likelihood_kls_posterior_prior(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T]; show_surprisals=true)

# ╔═╡ 67af74c2-b8ae-4d0e-81a9-b835ab99cc0a
plot_es_posterior(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T])
