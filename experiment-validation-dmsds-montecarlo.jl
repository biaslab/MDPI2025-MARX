...
# ╔═╡ 29fc7362-24eb-44c4-8942-63f9c5e5d5a0
using Distributions
...
# ╔═╡ bafa75d6-3b76-4d64-a2bb-071295f82f88
Δt, N_y, N_u, νadd, ulims = 0.05, 5, 5, 2, (-500.0, 500.0)

# ╔═╡ 4a4882d2-f0c9-478a-8c50-4249baf92711
...
#Ts = [2^i for i in 2:10]
#Ts = collect(2^3:2^4:2^8)
#Ts = collect(2^3:2^3:2^6)
#Ts = collect(2^3:2^4:2^8)
#Ts = [2^i for i in 2:8]
Ts = [2^i for i in 2:6]
...
# ╔═╡ 0eeb855d-5117-4660-803b-2b05e1a4fb6c
N_runs * length(Ts)

# ╔═╡ f988a709-36b9-4c36-b71d-deadbc27fe07
dpi = 300

# ╔═╡ 6899ed0a-d995-4c26-8a0c-a7a58b9d02e7
md"# Testing: Monte Carlo experiments for different training sizes"

# ╔═╡ b770886d-65ed-45ad-b892-edb93a604fd8
@time agents_marx_weak, envs_train_marx_weak, envs_test_marx_weak, recs_train_marx_weak, recs_test_marx_weak, rmses_marx_weak = monte_carlo_experiment_T(Ts, N_runs, f_env, MARXAgent, Δt, ulims, N_y, N_u, νadd, cΩ_weak, cΛ_weak)

# ╔═╡ 3ffcda0a-cf6f-4d0f-ada9-4405c2655985
@time agents_marx_UI, envs_train_marx_UI, envs_test_marx_UI, recs_train_marx_UI, recs_test_marx_UI, rmses_marx_UI = monte_carlo_experiment_T(Ts, N_runs, f_env, MARXAgent, Δt, ulims, N_y, N_u, νadd, cΩ_uninformative, cΛ_uninformative)

# ╔═╡ 6a4f1069-c4ac-441c-a417-f3b4f4268c8a
@time agents_RLS, envs_train_RLS, envs_test_RLS, recs_train_RLS, recs_test_RLS, rmses_RLS = monte_carlo_experiment_T(Ts, N_runs, f_env, OnlineLeastSquaresAgent, Δt, ulims, N_y, N_u, νadd, 0.0, 0.0)

# ╔═╡ 16d7e336-181b-41fc-9145-6f88411bc0eb
rmses_all = [("MARX-WI", mean(rmses_marx_weak, dims=1)), ("MARX-UI", mean(rmses_marx_UI, dims=1)), ("RLS", mean(rmses_RLS, dims=1))]

# ╔═╡ 81806ff1-3580-44a5-a7eb-143b3cce8b7b
plot_rmse_line_baseline(rmses_all, Ts, f_name="figures/dmsds-montecarlo-ribbonedline-baseline-sum.png")#, psize=(3*dpi, dpi))
